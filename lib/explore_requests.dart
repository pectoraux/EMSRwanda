...
//                Icon(Icons.search, color: Colors.black54)
      ...
      onPressed:(){
        ...
        new AlertDialog(
          ...
          title: new Text("Search For A Specific Request"),
          content: new Column(
              children: <Widget>[
                new ListTile(
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('Made By you', style: TextStyle(color: Colors.blueAccent)),
                ...
                (
                  ...
                  [
                    Column
                      ...
                      children: <Widget>
                      [
                        Text('Made To You', style: TextStyle(color: Colors.redAccent)),
                ...
                (
                  ...
                  [
                    Column
                      ...
                      [
                        Text('Made By You', style: TextStyle(color: Colors.blueAccent)),
                        Text('CROS', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 25.0))
                      ],
                    ),
                    Material
                      (
