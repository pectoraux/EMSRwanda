                ...
                [
                  ...
                  (
                    ...
                    [
                      ...
                      Text('FSI', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                    ],
                  ),
                  Material
                  (
                      ...
                      (
                        ...
                        [
                          ...
                          (
                            ...
                            children: <Widget>
                            [
                              Text('People Surveyed', style: TextStyle(color: Colors.green)),
                              Text('${people_surveyed}', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                            ],
                          ),
                          DropdownButton
                          (
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('Devices', style: TextStyle(color: Colors.redAccent)),
                  ...
                  (
                    ...
                    (
                      ...
                      (
                        padding: EdgeInsets.all(16.0),
                        child: Icon(Icons.devices, color: Colors.white, size: 30.0),
                      )
                    )
                  )
                ]
